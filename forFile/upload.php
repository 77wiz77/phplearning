  ...
  <section>
    <?php
      ...
      */
      ...
      {
        $name = $_FILES['filename']['name']; //name это ключ массива $_FILES / в данном случае это сам файл
        move_uploaded_file($_FILES['filename']['tmp_name'], $name); //загрузить на сервер (в временную папку)
        echo "Файл загружен";
      }
    ?>
